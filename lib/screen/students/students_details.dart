...
class StudentsDetails extends StatefulWidget {
   StudentsDetails({super.key,required this.img,required this.name,required this.phone,required this.email,required this.dep,this.status});
  String img;
  String name;
  String phone;
  String email;
      ...
      crossAxisAlignment:CrossAxisAlignment.center ,
        children: [
          ...
          Row(
            ...
            children: [
              MyTextWidget(title: "${widget.name}",tSize: 30,),
            ],
          ),
